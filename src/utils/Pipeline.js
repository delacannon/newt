import { Class, Renderer } from "phaser";

const CustomPipeline = new Class({
  Extends: Renderer.WebGL.Pipelines.TextureTintPipeline,

  initialize: function CustomPipeline(game) {
    Renderer.WebGL.Pipelines.TextureTintPipeline.call(this, {
      game: game,
