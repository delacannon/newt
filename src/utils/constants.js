...
export const EDITOR_TEXTS = [
  ...
  },
  {
    ...
    y: TEXT_Y + 296,
    font: NEURO_FONT,
    text: "SOFTWARE: NEWT Blueprints Builder v100",
    size: FONT_SIZE,
    tint: TINT_TERTIARY,
    alpha: ALPHA_MAIN,
    key: "text_initial3",
  ...
  },
  {
    ...
    font: FONT,
    text: "[ESC] RESET-MAP::[F1] SHARE-MAP",
    size: FONT_SIZE,
    tint: TINT_MAIN,
    alpha: ALPHA_MAIN,
    key: "text_clearMap",
